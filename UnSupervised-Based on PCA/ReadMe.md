...
- **python实现：**
  ...
  - 基于LinearPCA的重构误差：
    ...
    - 练习版本：[Recon_Error_PCA_Numpy_Only](https://github.com/Albertsr/Anomaly-Detection/blob/master/UnSupervised-Based%20on%20PCA/Recon_Error_PCA_Numpy_Only.py) (不调用sklearn，只调用numpy实现，通过矩阵的奇异值分解(SVD)实现PCA)
