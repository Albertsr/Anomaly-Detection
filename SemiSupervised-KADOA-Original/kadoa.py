...
class KADOA:
    ...
    def __init__(self, anomalies, unlabel, classifer, cluster_algo='kmeans', n_clusters='auto', 
        ...
        '''
        self.dataset = StandardScaler().fit_transform(np.r_[anomalies, unlabel])
    ...
    def cal_weighted_score(self):
        ...
        kre = KPCA_Recon_Error(matrix=self.dataset, contamination=self.contamination, verbose=self.verbose,
